            ...
            <div className="p-6 md:p-12 relative min-h-full flex flex-col">
              ...
              <div className="flex items-center gap-6 md:gap-8 border-b border-bone-ink/10 pb-8 md:pb-10 mb-8 md:mb-10 mt-8 md:mt-0">
                ...
                <div>
                  ...
                  <div className="text-bone-ink/60 tracking-widest uppercase text-xs md:text-sm">{character.meaning}</div>
                </div>
              </div>
              ...
              <div className="space-y-10 md:space-y-12 flex-grow">
                {/* Oracle Image */}
                <section>
                  <h4 className="text-[10px] md:text-xs font-bold text-bone-ink/50 uppercase tracking-widest mb-4">原始甲骨形态</h4>
                ...
                {/* AI Insight */}
                <section>
                  <h4 className="text-[10px] md:text-xs font-bold text-bone-ink/50 uppercase tracking-widest mb-4">AI 深度释义</h4>
                  <div className="border-l-2 border-bone-ink pl-4 md:pl-6 py-1 md:py-2">
                    <p className="text-sm md:text-base text-bone-ink/80 leading-relaxed md:leading-loose font-serif">
              ...
              <div className="mt-10 md:mt-12 pt-6 md:pt-8 border-t border-bone-ink/10 text-center">
                <span className="text-[8px] md:text-[10px] uppercase tracking-widest text-bone-ink/30">Oracle Bone Inscriptions Database</span>
              </div>
            </div>
          </motion.div>
        </>
